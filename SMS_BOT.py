...
# রেন্ডার সেটিংস থেকে তথ্য নেওয়া
...
VERIFY_TOKEN = os.environ.get('Abid0020')
...
def send_message(recipient_number, message_body):
    ...
    payload = {"messaging_product": "whatsapp", "to": recipient_number, "type": "text", "text": {"body": message_body}}
