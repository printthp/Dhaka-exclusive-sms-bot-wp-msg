...
def admin_login():
    # যদি আগে থেকেই লগইন করা থাকে, সরাসরি ড্যাশবোর্ডে পাঠান
    ...
    if request.method == "POST":
        ...
        if agent:
            # সেশন তৈরি
            session.permanent = True # সেশন পারমানেন্ট করার জন্য
            ...
            return render_template_string("""
                <div style='text-align:center;padding:50px;font-family:sans-serif;'>
                    <h2 style='color:red'>লগইন ব্যর্থ!</h2>
                    <p>ইউজারনেম অথবা পাসওয়ার্ড ভুল।</p>
                    <a href='/admin/login'>আবার চেষ্টা করুন</a>
                </div>
            """)
            
    # লগইন ফর্ম
    return render_template_string("""
        <form method='POST' style='max-width:300px;margin:100px auto;text-align:center;font-family:sans-serif;'>
            <h2 style='color: #4f46e5;'>Admin Login</h2>
            <input name='username' placeholder='Username' required style='width:100%;padding:10px;margin:5px 0;border:1px solid #ccc;border-radius:5px;'>
            <input name='password' type='password' placeholder='Password' required style='width:100%;padding:10px;margin:5px 0;border:1px solid #ccc;border-radius:5px;'>
            <button type='submit' style='padding:10px 20px;background:#4f46e5;color:white;border:none;border-radius:5px;cursor:pointer;'>Login</button>
        </form>
    """)
